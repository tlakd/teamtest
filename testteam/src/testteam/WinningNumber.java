...
public class WinningNumber {
	...
	String numberText;
	String firstNumber;
	private JLabel albl2;
	private JLabel albl3;
	private JLabel albl4;
	private JLabel albl5;
	private JLabel albl6;
	private JLabel albl;
	...
	public void 자동여러장구매시(Map<Integer, List<NumberSave>> userNumber, Map<Integer, String> autoNotAuto) {
        for (int i = 1; i <= userNumber.size(); i++) {
            ...
            albl2.setText(String.valueOf(numbers.get(1)));
            albl3.setText(String.valueOf(numbers.get(2)));
            albl4.setText(String.valueOf(numbers.get(3)));
            albl5.setText(String.valueOf(numbers.get(4)));
            albl6.setText(String.valueOf(numbers.get(5)));
